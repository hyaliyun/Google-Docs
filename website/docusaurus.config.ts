...
function getLastStableVersion() {
  ...
  if (!lastStableVersion) {
    throw new Error('unexpected, no stable Google Docs version?');
  }
...
if (isSlower) {
  console.log('🐢 Using slower Google Docs build');
}
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/Google-Docs/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Docs/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Docs/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Docs/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
    ...
    themeConfig: {
      ...
      navbar: {
        ...
        items: [
          ...
          // Right
          {to: 'show', label: 'Show', position: 'right'},
          {
            type: 'localeDropdown',
            position: 'right',
            dropdownItemsAfter: [
              ...
              {
                href: 'https://github.com/hyaliyun/Google-Docs/issues/2',
                label: 'Help Us Translate',
              },
            ],
          },
          {
            href: 'https://github.com/hyaliyun/Google-Docs',
            position: 'right',
