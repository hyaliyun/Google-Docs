...
The `toString()` method requires its `this` value to be a `String` primitive or wrapper object. It throws a  for other `this` values without attempting to coerce them to string values.
