...
- Methods, such as {{jsxref("ArrayBuffer/resize", "resize()")}} and {{jsxref("ArrayBuffer/slice", "slice()")}}, throw a  when invoked. The associated typed array views' methods also throw a `TypeError`.
