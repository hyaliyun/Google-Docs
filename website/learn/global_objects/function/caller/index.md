...
The **`caller`** accessor property of {{jsxref("Function")}} instances returns the function that invoked this function. For [strict](/Web/JavaScript/Reference/Strict_mode), arrow, async, and generator functions, accessing the `caller` property throws a .
