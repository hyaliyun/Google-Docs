...
In ES5, if the argument to this method is not an object (a primitive), then it will cause a . In ES2015, it will return `true` without any errors if a non-object argument is passed, since primitives are, by definition, immutable.
